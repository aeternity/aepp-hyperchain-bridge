...
const styles = {
  ...
  colors: {
    ...
    primary: [
      "text-white [--btn-hover-overlay:var(--color-white)]/10 [--btn-bg:var(--color-aepink-900)] [--btn-border:var(--color-aepink)]/90",
      "[--btn-icon:var(--color-aepink-300)] data-active:[--btn-icon:var(--color-aepink-100)] data-hover:[--btn-icon:var(--color-aepink-100)]",
    ],
  },
};
